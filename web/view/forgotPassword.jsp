<%-- 
    ...
    Created on : Mar 18, 2025, 10:04:45 PM
    Author     : Dell
--%>
...
/*                    font-weight: bold;*/
                                ...
                                <div class="form_container">
                                    ...
                                    <form action="${pageContext.request.contextPath}/forgotPassword" method="post">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="cccd" name="cccd" class="form-control" placeholder="Nhập CCCD đã đăng kí" required>
                                        </div>
                                        <div class="btn_box">
                                            <button type="submit">
                                                Nhận OTP
            ...
            <div>
                ...
                <form action="${pageContext.request.contextPath}/forgotPassword" method="post">
                    <input type="hidden" name="action" value="requestOTP">
                    <label for="cccd">Nhập CCCD đã đăng ký:</label>
